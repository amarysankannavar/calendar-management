...
public class MeetingManage {
  ...
  public interface Iface {
    ...
    public boolean canScheduleMeeting(java.util.List<Integer> employeeIds, String date, String startTime, String endTime) throws MeetingException, org.apache.thrift.TException;

    public int scheduleMeeting(String description, String agenda, java.util.List<Integer> employeeIds, String date, String startTime, String endTime, int roomId) throws MeetingException, org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class canScheduleMeeting_call extends org.apache.thrift.async.TAsyncMethodCall<Boolean> {
      ...
      @Override
      public Boolean getResult() throws MeetingException, org.apache.thrift.TException {
    ...
    public static class scheduleMeeting_call extends org.apache.thrift.async.TAsyncMethodCall<Integer> {
      ...
      @Override
      public Integer getResult() throws MeetingException, org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class canScheduleMeeting_result implements org.apache.thrift.TBase<canScheduleMeeting_result, canScheduleMeeting_result._Fields>, java.io.Serializable, Cloneable, Comparable<canScheduleMeeting_result>   {
    ...
    public int compareTo(canScheduleMeeting_result other) {
      ...
      lastComparison = Boolean.compare(isSetEx(), other.isSetEx());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetEx()) {
